...
**NOTE:**  Inductive Automation maintains the official [Ignition image on Docker Hub](https://hub.docker.com/r/inductiveautomation/ignition) for the 8.1+ series of releases.  Check out that page if you're interested in running your containers in production.  This is also where to go for _nightly_ images, too!
